...
RISK_PATTERNS_V41: List[RiskPattern] = [
    ...
    # -----------------------------
    {
        ...
        "trigger_phrases": [
            ...
            "debo tener una novia mucho mas joven",
            "debo tener una pareja mucho mas joven",
            "quiero tener una novia mucho mas joven",
            "quiero tener una pareja mucho mas joven",
            "pareja mucho menor",
